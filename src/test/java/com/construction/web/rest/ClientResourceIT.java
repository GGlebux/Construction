...
import static com.construction.domain.ClientAsserts.*;
...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().fullName(DEFAULT_FULL_NAME).email(DEFAULT_EMAIL);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().fullName(UPDATED_FULL_NAME).email(UPDATED_EMAIL);
        return client;
    }
    ...
    @Test
    @Transactional
    void getAllClientsByFullNameIsEqualToSomething() throws Exception {
        // Initialize the database
        clientRepository.saveAndFlush(client);

        // Get all the clientList where fullName equals to
        defaultClientFiltering("fullName.equals=" + DEFAULT_FULL_NAME, "fullName.equals=" + UPDATED_FULL_NAME);
    }

    @Test
    @Transactional
    void getAllClientsByFullNameIsInShouldWork() throws Exception {
        // Initialize the database
        clientRepository.saveAndFlush(client);

        // Get all the clientList where fullName in
        defaultClientFiltering("fullName.in=" + DEFAULT_FULL_NAME + "," + UPDATED_FULL_NAME, "fullName.in=" + UPDATED_FULL_NAME);
    }

    @Test
    @Transactional
    void getAllClientsByFullNameIsNullOrNotNull() throws Exception {
        // Initialize the database
        clientRepository.saveAndFlush(client);

        // Get all the clientList where fullName is not null
        defaultClientFiltering("fullName.specified=true", "fullName.specified=false");
    }

    @Test
    @Transactional
    void getAllClientsByFullNameContainsSomething() throws Exception {
        // Initialize the database
        clientRepository.saveAndFlush(client);

        // Get all the clientList where fullName contains
        defaultClientFiltering("fullName.contains=" + DEFAULT_FULL_NAME, "fullName.contains=" + UPDATED_FULL_NAME);
    }

    @Test
    @Transactional
    void getAllClientsByFullNameNotContainsSomething() throws Exception {
        // Initialize the database
        clientRepository.saveAndFlush(client);

        // Get all the clientList where fullName does not contain
        defaultClientFiltering("fullName.doesNotContain=" + UPDATED_FULL_NAME, "fullName.doesNotContain=" + DEFAULT_FULL_NAME);
    }
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.fullName(UPDATED_FULL_NAME).email(UPDATED_EMAIL);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.fullName(UPDATED_FULL_NAME);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.fullName(UPDATED_FULL_NAME).email(UPDATED_EMAIL);
