...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUILDINGPROJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BUILDINGPROJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BUILDINGPROJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BUILDINGPROJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BUILDINGPROJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BUILDINGPROJECT actions', async () => {
      const arg = 42666;
