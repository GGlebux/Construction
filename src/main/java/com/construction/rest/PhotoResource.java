...
/**
 * REST controller for managing {@link com.construction.models.Photo}.
 */
@RestController
...
public class PhotoResource {
    ...
    public ResponseEntity<PhotoDTO> createPhoto(@Valid @RequestBody PhotoDTO photoDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/photos/" + photoDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, photoDTO.getId().toString()))
            .body(photoDTO);
    }
